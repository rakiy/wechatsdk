...
namespace rakiy\Wechat;

use rakiy\Wechat\Lib\Common;
use rakiy\Wechat\Lib\Tools;
...
class WechatScript extends Common
{
     ...
     */
    public function getJsSign($url, $jsapilist=[], $timestamp = 0, $noncestr = '', $appid = '', $access_token = '')
    {
